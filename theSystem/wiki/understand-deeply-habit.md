...
domain: 8
room: 21
wiki_source: wiki/learning-systems/understand-deeply-habit.md
---
...
```mermaid
graph TD
  A["COMPLEX ISSUE<br/>(what you face)"]
  B["FIND THE EASIER PROBLEM<br/>— Polya"]
  C["4 SUB-MOVES<br/>① Understand simple things deeply (Tony Plog)<br/>② Clear the clutter — seek the essential (Picasso)<br/>③ See what's there (Galileo · Bohr · Monk-by-Sea)<br/>④ See what's missing (negative space · adjectives)"]
  D["ROCK-SOLID FOUNDATION layer<br/>(everything else above<br/>is built upon this)"]
  A -->|"Earth refuses to<br/>engage head-on"| B
  B --> C
  C --> D
```
