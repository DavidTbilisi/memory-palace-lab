...
domain: 10
room: 1
wiki_source: wiki/learning-systems/early-childhood-skill-stack.md
---
...
```mermaid
flowchart TD
    %% Wave 0 — birth to ~3, ambient exposure
    L2_AUDIO[L2 audio exposure]:::w0
    NARRATIVE[Listening to stories]:::w0
    SUBITIZE[Subitizing 1-6]:::w0
    MUSIC_EAR[Music listening + rhythm play]:::w0
    PLAY[Free play / fine motor]:::w0

    %% Wave 1 — 3-5, first deliberate drilling
    PHONICS[Phonics start]:::w1
    FINGER_ARITH[Finger arithmetic]:::w1
    LETTER_FORM[Letter formation by hand]:::w1
    INSTRUMENT_EXPLORE[Instrument exploration]:::w1
    SHORT_POEMS[Short poem memorization]:::w1

    %% Wave 2 — 5-7, substrate drive to fluency
    READING_FLUENT[Reading fluency Lamp+Scale]:::w2
    HANDWRITING_FLUENT[Handwriting fluent]:::w2
    FRIENDS_5_10[Friends-of-5/10]:::w2
    SOROBAN[Soroban physical]:::w2
    INSTRUMENT_LESSONS[Instrument formal lessons]:::w2
    L2_PRODUCTION[L2 single-word production]:::w2
    CHESS_BASIC[Chess rules + first motifs]:::w2

    %% Wave 3 — 7-9, Sword phase on substrate
    READING_SWORD[Reading Sword 130+ wpm]:::w3
    TIMES_TABLES[Multiplication tables 12x12]:::w3
    SOROBAN_MENTAL[Mental soroban]:::w3
    INSTRUMENT_NOTATION[Sight-reading at grade level]:::w3
    CHESS_MOTIFS[Chess tactical-motif gym]:::w3
    LONG_MEMORIZATION[100-line memorization]:::w3

    %% Wave 4 — 8-10, productivity layer + transfer
    TOUCH_TYPING[Touch typing 50+ wpm]:::w4
    TWO_DIGIT_MENTAL[Two-digit mental arithmetic]:::w4
    BLITZ_CHESS[Blitz chess 5+0]:::w4
    L2_CONVO[L2 native conversation]:::w4
    SEMANTIC_READING[Semantic reading modes]:::w4

    NARRATIVE --> PHONICS
    SUBITIZE --> FINGER_ARITH
    PLAY --> LETTER_FORM
    PLAY --> INSTRUMENT_EXPLORE
    MUSIC_EAR --> INSTRUMENT_EXPLORE
    L2_AUDIO --> L2_PRODUCTION

    PHONICS --> READING_FLUENT
    LETTER_FORM --> HANDWRITING_FLUENT
    FINGER_ARITH --> FRIENDS_5_10
    FRIENDS_5_10 --> SOROBAN
    INSTRUMENT_EXPLORE --> INSTRUMENT_LESSONS
    SHORT_POEMS --> LONG_MEMORIZATION

    READING_FLUENT --> READING_SWORD
    READING_FLUENT --> CHESS_BASIC
    READING_FLUENT --> TIMES_TABLES
    READING_FLUENT --> INSTRUMENT_NOTATION
    HANDWRITING_FLUENT --> READING_SWORD
    SOROBAN --> SOROBAN_MENTAL
    INSTRUMENT_LESSONS --> INSTRUMENT_NOTATION
    CHESS_BASIC --> CHESS_MOTIFS

    READING_SWORD --> TOUCH_TYPING
    HANDWRITING_FLUENT --> TOUCH_TYPING
    TIMES_TABLES --> TWO_DIGIT_MENTAL
    SOROBAN_MENTAL --> TWO_DIGIT_MENTAL
    CHESS_MOTIFS --> BLITZ_CHESS
    L2_PRODUCTION --> L2_CONVO
    READING_SWORD --> SEMANTIC_READING

    classDef w0 fill:#eef,stroke:#88a
    classDef w1 fill:#efe,stroke:#8a8
    classDef w2 fill:#fee,stroke:#a88
    classDef w3 fill:#ffe,stroke:#aa8
    classDef w4 fill:#fef,stroke:#a8a
```
