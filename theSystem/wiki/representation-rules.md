...
*Disambiguation: this is a **set**, not a ladder — the rules are unordered and Rule 11 is not a "level 11". It is unrelated to automaticity's 10 levels (0–9), whose numbering is owned by [skill-progression-stages](./skill-progression-stages.md).*
