...
room: 2
glyph: 📶
wiki_source: wiki/learning-systems/maturity-levels-overview.md
---
...
```mermaid
graph TD
  L1["Level 1: Concept<br/>You understand WHY"] --> L2["Level 2: Simple Palace<br/>You CAN walk a palace"]
  L2 --> L3["Level 3: Tier 1 Encoding<br/>You CAN encode Tier 1 edges"]
  L3 --> L4["Level 4: Small Flat Networks<br/>You CAN analyze & place nodes"]
  L4 --> L5["Level 5: Tier 2 CAST<br/>You CAN handle collisions"]
  L5 --> L6["Level 6: Patterns & Loops<br/>You CAN recognize structures"]
  L6 --> L7["Level 7: Nested Palaces<br/>You CAN encode hierarchies"]
  L7 --> L8["Level 8: DAGs & Cross-Edges<br/>You CAN integrate tree + CAST"]
  L8 --> L9["Level 9: Temporal & Complex<br/>You CAN tell the story"]
  L9 --> L10["Level 10: Mastery & Optimization<br/>You CAN optimize & teach"]
```
